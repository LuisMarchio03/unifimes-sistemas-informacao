...
class FormUserWidget extends StatefulWidget {
  ...
  static String routeName = 'form_User';
  static String routePath = '/formUser';
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: Image.network(
                                              'https://images.unsplash.com/photo-1633332755192-727a05c4013d?w=100&h=100',
                                              fit: BoxFit.cover,
                                            ),
                                          ),
                                        ),
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            FlutterFlowChoiceChips(
                                              options: [
                                                ChipData('Administrador'),
                                                ChipData('Veterinário'),
                                                ChipData('Recepcionista'),
                                                ChipData('Auxiliar'),
                                                ChipData('Financeiro')
                                              ],
                                              onChanged: (val) => safeSetState(
                                                          ...
                                                          borderRadius:
                                                              BorderRadius
                                                                  .circular(
                                                                      20.0),
                                                          child: Image.network(
                                                            'https://images.unsplash.com/photo-1543466835-00a7907e9de1?w=40&h=40',
                                                            width: 40.0,
                                                            height: 40.0,
                                                            fit: BoxFit.cover,
                                                          ),
                                                          ...
                                                          borderRadius:
                                                              BorderRadius
                                                                  .circular(
                                                                      20.0),
                                                          child: Image.network(
                                                            'https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?w=40&h=40',
                                                            width: 40.0,
                                                            height: 40.0,
                                                            fit: BoxFit.cover,
                                                          ),
                                                          ...
                                                          borderRadius:
                                                              BorderRadius
                                                                  .circular(
                                                                      20.0),
                                                          child: Image.network(
                                                            'https://images.unsplash.com/photo-1425082661705-1834bfd09dca?w=40&h=40',
                                                            width: 40.0,
                                                            height: 40.0,
                                                            fit: BoxFit.cover,
                                                          ),
                            ...
                            Row(
                              ...
                              children: [
                                FFButtonWidget(
                                  onPressed: () async {
                                    context
                                        .pushNamed(MainUsersWidget.routeName);
                                  },
                                  text: 'Cancelar',
                                  options: FFButtonOptions(
                                    width: 120.0,
