...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF029CD4);
  late Color secondary = const Color(0xFF363334);
  late Color tertiary = const Color(0xFF382525);
  ...
  late Color accent1 = const Color(0xFF0076A1);
  late Color accent2 = const Color(0x71020202);
  late Color accent3 = const Color(0xFF2B1C1C);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF006C94);
  late Color secondary = const Color(0xFF363334);
  late Color tertiary = const Color(0xFF2B1C1C);
  late Color alternate = const Color(0xFF313442);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFFA9ADC6);
  late Color primaryBackground = const Color(0xFF15171E);
  late Color secondaryBackground = const Color(0xFF1B1D27);
  late Color accent1 = const Color(0xFF00455E);
  late Color accent2 = const Color(0xFF232222);
  late Color accent3 = const Color(0xFF1F1515);
  ...
  late Color background = Color(0xFF1B1F27);
}
